<form class="cmxform form-horizontal tasi-form" id="commentForm" method="POST" action="/modelo/new/<?php echo $oMarca->id ?>">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-6">
            <input class="form-control" id="second_last_name" type="text" name="version" required="required">
        </div>
    </div>
    <div class="form-group">
