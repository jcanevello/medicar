<h2 class="page-title">Vehículo: <?php echo $oSolicitud->placa ?></h2>
            ...
            <div class="col-sm-12">
                <form class="form-inline" action="" method="POST">
                    <div class="form-group">
                        <label class="control-label col-sm-12">Nombre del cliente:</label>
                    </div>
                    <div class="form-group">
                        <input type="text" name="nombre" class="form-control col-sm-12" required="required">
                    </div>
                    <div class="form-group">
                        <button class="btn btn-success btn-lg m-l-10" type="submit">Confirmar Pago</button>
                    </div>
                </form>
            </div>
        </div>
                ...
                <div style="border: 1px solid #006699; border-radius: 6px;background: #ffffff; padding: 5px; display: table;">
                    ...
                    <div style="display: inline-block; width: 177px; position: relative; bottom: 0px;margin-right: 15px;">
                        ...
                        <div style="border-radius: 6px; border: 1px solid #484c8a; width: 100%; padding: 5px; text-align: center; margin-bottom: 5px;">
                            <span style="font-weight: bold; color: red;">N° </span>
                        </div>
                        <div style="border: 1px solid #484c8a; border-radius: 6px;">
                            ...
                            <div style="border-top: 1px solid #484c8a; margin-top: 1px;">
                                <div style="display: inline-block; width: 55px; text-align: center;"><span><?php echo date('d') ?></span></div>
                                <div style="display: inline-block; width: 55px; text-align: center; border-right: 1px solid #484c8a; border-left: 1px solid #484c8a;"><span><?php echo date('m') ?></span></div>
                                <div style="display: inline-block; width: 55px; text-align: center;"><span><?php echo date('y') ?></span></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <table style="width: 100%; margin-top: 20px; margin-bottom: 20px;">
                        <tr>
                            <td colspan="4">
                                ...
                                <span style="border-bottom: 1px solid #484c8a; border-bottom-style: dashed; display: inline-block; width: 436px;"></span>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="4">
