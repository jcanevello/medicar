...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-04-2017 a las 00:48:59
...
CREATE TABLE IF NOT EXISTS `garantia_mecanico` (
...
(6, 'b0z391', 2, 1, '2017-04-09'),
(7, 'b0z391', 1, 1, '2017-04-09');
...
CREATE TABLE IF NOT EXISTS `usr_profile_action` (
`id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `usr_try_login` (
`id` int(11) NOT NULL,
...
--
ALTER TABLE `boleta`
 ADD PRIMARY KEY (`num_boleta`), ADD KEY `fk_boleta_solicitud1_idx` (`solicitud_id`);
...
ALTER TABLE `garantia_mecanico`
 ADD KEY `fk_table1_garantia1_idx` (`garantia_id`), ADD KEY `fk__mecanico1_idx` (`mecanico_id`);
...
--
ALTER TABLE `modelo`
 ADD PRIMARY KEY (`id`), ADD KEY `fk_modelo_marca_idx` (`marca_id`);
...
ALTER TABLE `solicitud`
 ADD PRIMARY KEY (`id`), ADD KEY `fk_pedido_vehiculo1_idx` (`placa`), ADD KEY `fk_pedido_mecanico1_idx` (`mecanico_id`);

--
-- Indices de la tabla `solicitud_servicio`
--
ALTER TABLE `solicitud_servicio`
 ADD KEY `fk_pedido_servicio_pedido1_idx` (`solicitud_id`), ADD KEY `fk_pedido_servicio_servicio1_idx` (`servicio_id`);
...
ALTER TABLE `usr_profile_action`
 ADD PRIMARY KEY (`id`), ADD KEY `fk_table1_accion1_idx` (`action_id`), ADD KEY `fk_perfil_accion_perfil1_idx` (`profile_id`);

--
-- Indices de la tabla `usr_try_login`
--
ALTER TABLE `usr_try_login`
 ADD PRIMARY KEY (`id`), ADD KEY `fk_usr_try_login_usr_user1_idx` (`user_id`);

--
-- Indices de la tabla `usr_user`
--
ALTER TABLE `usr_user`
 ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `usuario_UNIQUE` (`username`), ADD KEY `fk_usuario_perfil1_idx` (`profile_id`);

--
-- Indices de la tabla `vehiculo`
--
ALTER TABLE `vehiculo`
 ADD PRIMARY KEY (`placa`), ADD KEY `fk_vehiculo_modelo1_idx` (`modelo_id`);
